...
function showFloors(index) {
    ...
    if ($(window).width() <= 768) {
        $(".project__floors-slider").animate({"top": "20px", duration: 6000});
    } else {
        $(".project__floors-slider").animate({"top": "30px", duration: 6000});
    }   
    $(".big-floors").css({display: "block"});

    $floors = $(".floors-carousel").flickity({
...
function showHouses(index) {
    ...
    if ($(window).width() <= 768) {
        $(".houses-slider").animate({"top": "20px", duration: 6000});
    } else {
        $(".houses-slider").animate({"top": "30px", duration: 6000});
    }   
    $(".big-houses").css({display: "block"});

    $houses = $(".houses-carousel").flickity({
